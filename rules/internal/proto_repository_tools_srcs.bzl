...
PROTO_REPOSITORY_TOOLS_SRCS = [
	...
	"@build_stack_rules_proto//example/golden/not_yet_working/php:BUILD.bazel",
	...
	"@build_stack_rules_proto//rules/internal:BUILD.bazel",
	"@build_stack_rules_proto//rules/internal:list_repository_tools_srcs.go",
