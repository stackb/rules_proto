...
PROTO_REPOSITORY_TOOLS_SRCS = [
    ...
    "@build_stack_rules_proto//pkg/plugin/protocolbuffers/protobuf-javascript:BUILD.bazel",
    "@build_stack_rules_proto//pkg/plugin/protocolbuffers/protobuf-javascript:js_es6_plugin.go",
    ...
    "@build_stack_rules_proto//plugin/protocolbuffers/protobuf-javascript:BUILD.bazel",
