...
PROTO_REPOSITORY_TOOLS_SRCS = [
    ...
    "@build_stack_rules_proto//language/protoresolve:BUILD.bazel",
    "@build_stack_rules_proto//language/protoresolve:protoresolve.go",
    ...
    "@build_stack_rules_proto//pkg/language/protobuf:protobuf.go",
    "@build_stack_rules_proto//pkg/language/protoresolve:BUILD.bazel",
    "@build_stack_rules_proto//pkg/language/protoresolve:protoresolve.go",
    ...
    "@build_stack_rules_proto//pkg/protoresolve:BUILD.bazel",
    "@build_stack_rules_proto//pkg/protoresolve:protoresolve.go",
