...
ProtoRuleInfo = provider("Provider for a proto rule", fields = {
    ...
    "deps": "A list<ProtoDependencyInfo>",
})
...
proto_rule = rule(
    ...
    attrs = {
        ...
        "implementation_tmpl": attr.label(
            ...
            default = str(Label("@build_stack_rules_proto//core:proto_compile.bzl.tmpl")),
            allow_single_file = True,
        ),
        "workspace_example_tmpl": attr.label(
            doc = "The rule workspace example template",
            default = str(Label("@build_stack_rules_proto//core:WORKSPACE.tmpl")),
            allow_single_file = True,
        ),
        "build_example_tmpl": attr.label(
            doc = "The rule build example template",
            default = str(Label("@build_stack_rules_proto//core:BUILD.tmpl")),
            allow_single_file = True,
        ),
        "markdown_tmpl": attr.label(
            doc = "The rule build markdown example template",
            default = str(Label("@build_stack_rules_proto//core:proto_rule.md.tmpl")),
            allow_single_file = True,
        ),
        "deps_tmpl": attr.label(
            doc = "The workspace deps example template",
            default = str(Label("@build_stack_rules_proto//core:deps.bzl.tmpl")),
            allow_single_file = True,
        ),
        "bazel_test_tmpl": attr.label(
            doc = "The workspace bazel_test example template",
            default = str(Label("@build_stack_rules_proto//core:bazel_test.go.tmpl")),
            allow_single_file = True,
        ),
        ...
        "deps": attr.label_list(
            ...
            default = [str(Label("@build_stack_rules_proto//core:com_google_protobuf"))],
        ),
        "_rulegen": attr.label(
