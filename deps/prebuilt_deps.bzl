"prebuilt_deps.bzl contains repository rules for pulling precompiled protoc"
...
""",
    ...
    _maybe(
        ...
        sha256 = "0decc6ce5beed07f8c20361ddeb5ac7666f09cf34572cca530e16814093f9c0c",
        urls = ["https://github.com/google/protobuf/releases/download/v3.6.1/protoc-3.6.1-win32.zip"],
        build_file_content = """
filegroup(
    name = "protoc",
    srcs = ["bin/protoc.exe"],
