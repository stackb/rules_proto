...
| [objc_grpc_library](#objc_grpc_library) | Generates objc protobuf+gRPC library |
...
Generates objc protobuf+gRPC library

### `WORKSPACE`

```python
load("@build_stack_rules_proto//objc:deps.bzl", "objc_grpc_library")
...
```python
load("@build_stack_rules_proto//objc:objc_grpc_library.bzl", "objc_grpc_library")

objc_grpc_library(
    name = "greeter_objc_library",
    deps = ["@build_stack_rules_proto//example/proto:greeter_grpc"],
)
```
