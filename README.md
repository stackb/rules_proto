...
| experimental | [dart](/dart) | [dart_grpc_library](/dart#dart_grpc_library) | Generates dart protobuf+gRPC library ([example](/example/dart/dart_grpc_library)) |
...
| [![Build Status](https://badge.buildkite.com/5980cc1d55f96e721bd9a7bd5dc1e40a096a7c30bc13117910.svg?branch=master)](https://buildkite.com/bazel/rules-proto) | [python](/python) | [python_proto_aspect_compile](/python#python_proto_aspect_compile) | Generates *.py protobuf artifacts using aspect based compilation ([example](/example/python/python_proto_aspect_compile)) |
| [![Build Status](https://badge.buildkite.com/5980cc1d55f96e721bd9a7bd5dc1e40a096a7c30bc13117910.svg?branch=master)](https://buildkite.com/bazel/rules-proto) | [python](/python) | [python_grpc_aspect_compile](/python#python_grpc_aspect_compile) | Generates *.py protobuf+gRPC artifacts using aspect based compilation ([example](/example/python/python_grpc_aspect_compile)) |
...
| [![Build Status](https://badge.buildkite.com/5980cc1d55f96e721bd9a7bd5dc1e40a096a7c30bc13117910.svg?branch=master)](https://buildkite.com/bazel/rules-proto) | [ruby](/ruby) | [ruby_proto_aspect_compile](/ruby#ruby_proto_aspect_compile) | Generates *.ruby protobuf artifacts using aspect based compilation ([example](/example/ruby/ruby_proto_aspect_compile)) |
| [![Build Status](https://badge.buildkite.com/5980cc1d55f96e721bd9a7bd5dc1e40a096a7c30bc13117910.svg?branch=master)](https://buildkite.com/bazel/rules-proto) | [ruby](/ruby) | [ruby_grpc_aspect_compile](/ruby#ruby_grpc_aspect_compile) | Generates *.ruby protobuf+gRPC artifacts using aspect based compilation ([example](/example/ruby/ruby_grpc_aspect_compile)) |
...
4. `example/{lang}/{rule}/`: contains a generated `WORKSPACE` and `BUILD.bazel`
