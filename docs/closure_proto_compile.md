---
layout: default
title: closure_proto_compile
permalink: closure/closure_proto_compile
parent: closure
---
...
load("@build_stack_rules_proto//rules:closure_proto_compile_deps.bzl", "closure_proto_compile_deps")
...
load("@build_stack_rules_proto//rules:closure_proto_compile.bzl", "closure_proto_compile")
...
closure_proto_compile(
    name = "closure_proto_compile_foo_proto",
    deps = [":foo_proto"],
)
```
...
def closure_proto_compile_deps():
    ...
    com_google_protobuf()  # via rule closure_proto_compile
