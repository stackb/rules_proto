...
def java_grpc_compile_deps():
    ...
    com_google_protobuf()  # via rule java_grpc_compile
    rules_jvm_external()  # via io_grpc_grpc_java
    io_grpc_grpc_java()  # via rule java_grpc_compile
    rules_java()  # via rule java_grpc_compile
