---
layout: default
title: cc_proto_library
permalink: cc/cc_proto_library
parent: cc
---
...
load("@build_stack_rules_proto//rules:cc_proto_library_deps.bzl", "cc_proto_library_deps")
...
cc_proto_library(
    name = "cc_proto_library_foo_proto",
    deps = [":foo_proto"],
)
```
