...
def grpc_js_grpc_library_deps():
    ...
    com_google_protobuf()  # via rule grpc_js_grpc_library
    io_bazel_rules_closure()  # via rule grpc_js_grpc_library
    com_github_stackb_grpc_js()  # via rule grpc_js_grpc_library
