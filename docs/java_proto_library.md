---
layout: default
title: java_proto_library
permalink: java/java_proto_library
parent: java
---
...
load("@build_stack_rules_proto//rules:java_proto_library.bzl", "java_proto_library")
...
java_proto_library(
    name = "java_proto_library_foo_proto",
    deps = [":foo_proto"],
)
```
...
def java_proto_library_deps():
    ...
    com_google_protobuf()  # via rule java_proto_library
    rules_java()  # via rule java_proto_library
