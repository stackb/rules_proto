---
layout: default
title: cc_grpc_library
permalink: cc/cc_grpc_library
parent: cc
---
...
load("@build_stack_rules_proto//rules:cc_grpc_library_deps.bzl", "cc_grpc_library_deps")

cc_grpc_library_deps()

# via plugin //plugins/cc/grpc:grpc
...
cc_grpc_library(
    name = "cc_grpc_library_foo_proto",
    deps = [":foo_proto"],
)
```
...
| `//plugins/cc/grpc:grpc` |  |  `{protopath}.grpc.pb.h` `{protopath}.grpc.pb.cc` `{protopath}_mock.grpc.pb.h` |
