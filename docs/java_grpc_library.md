---
layout: default
title: java_grpc_library
permalink: java/java_grpc_library
parent: java
---
...
load("@build_stack_rules_proto//rules:java_grpc_library.bzl", "java_grpc_library")
...
java_grpc_library(
    name = "java_grpc_library_foo_grpc",
    deps = [":greeter_proto"],
)
```
