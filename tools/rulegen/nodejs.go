	...
	return &Language{
		...
		Rules: []*Rule{
			&Rule{
				...
				Doc:              "Generates NodeJS *.js protobuf artifacts",
			...
			&Rule{
				...
				Doc:              "Generates NodeJS *.js protobuf+gRPC artifacts",
				Attrs:            aspectProtoCompileAttrs,
				SkipTestPlatforms: []string{"none"},
			},
// 			&Rule{
...
// 				Doc:              "Generates NodeJS *.js protobuf library",
// 				Attrs:            aspectProtoCompileAttrs,
...
// 				Doc:              "Generates NodeJS *.js protobuf+gRPC library",
// 				Attrs:            aspectProtoCompileAttrs,
// 				SkipTestPlatforms: []string{},
// 			},
		},
