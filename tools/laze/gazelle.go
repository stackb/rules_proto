...
func (*protoRuleLang) Loads() []rule.LoadInfo {
	return []rule.LoadInfo{
		{
			Name:    "@build_stack_rules_proto//language/rules:proto_language_info_provider_test.bzl",
			Symbols: []string{"proto_language_info_provider_test"},
		},
		{
			Name:    "@build_stack_rules_proto//language/rules:proto_info_provider_test.bzl",
			Symbols: []string{"proto_info_provider_test"},
		},
		{
			Name:    "@build_stack_rules_proto//language/rules:proto_plugin_info_provider_test.bzl",
			Symbols: []string{"proto_plugin_info_provider_test"},
		},
		{
			Name:    "@build_stack_rules_proto//language/rules:proto_rule_info_provider_test.bzl",
			Symbols: []string{"proto_rule_info_provider_test"},
		},
		{
			Name:    "@build_stack_rules_proto//language/rules:proto_rule_test.bzl",
