...
goog.provide('proto.routeguide.Feature');
goog.provide('proto.routeguide.FeatureDatabase');
goog.provide('proto.routeguide.Point');
goog.provide('proto.routeguide.Rectangle');
goog.provide('proto.routeguide.RouteNote');
goog.provide('proto.routeguide.RouteSummary');
 ...
 * @constructor
 */
proto.routeguide.FeatureDatabase = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.routeguide.FeatureDatabase.repeatedFields_, null);
};
goog.inherits(proto.routeguide.FeatureDatabase, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.routeguide.FeatureDatabase.displayName = 'proto.routeguide.FeatureDatabase';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.routeguide.FeatureDatabase.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.routeguide.FeatureDatabase.prototype.toObject = function(opt_includeInstance) {
  return proto.routeguide.FeatureDatabase.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.routeguide.FeatureDatabase} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.routeguide.FeatureDatabase.toObject = function(includeInstance, msg) {
  var f, obj = {
    featureList: jspb.Message.toObjectList(msg.getFeatureList(),
    proto.routeguide.Feature.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.routeguide.FeatureDatabase}
 */
proto.routeguide.FeatureDatabase.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.routeguide.FeatureDatabase;
  return proto.routeguide.FeatureDatabase.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.routeguide.FeatureDatabase} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.routeguide.FeatureDatabase}
 */
proto.routeguide.FeatureDatabase.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.routeguide.Feature;
      reader.readMessage(value,proto.routeguide.Feature.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.routeguide.FeatureDatabase.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.routeguide.FeatureDatabase.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.routeguide.FeatureDatabase} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.routeguide.FeatureDatabase.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.routeguide.Feature.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.routeguide.Feature>}
 */
proto.routeguide.FeatureDatabase.prototype.getFeatureList = function() {
  return /** @type{!Array<!proto.routeguide.Feature>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.routeguide.Feature, 1));
};


/**
 * @param {!Array<!proto.routeguide.Feature>} value
 * @return {!proto.routeguide.FeatureDatabase} returns this
*/
proto.routeguide.FeatureDatabase.prototype.setFeatureList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.routeguide.Feature=} opt_value
 * @param {number=} opt_index
 * @return {!proto.routeguide.Feature}
 */
proto.routeguide.FeatureDatabase.prototype.addFeature = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.routeguide.Feature, opt_index);
};
 ...
 * @return {!proto.routeguide.FeatureDatabase} returns this
 */
proto.routeguide.FeatureDatabase.prototype.clearFeatureList = function() {
