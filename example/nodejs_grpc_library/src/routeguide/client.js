...
const messages = require('./routeguide/proto/routeguide_pb.js')
const services = require('./routeguide/proto/routeguide_grpc_pb.js')

// This is included as data in the client node_module, so we can load
// this database as a constant.
const featureList = require('./routeguide_features.json');
